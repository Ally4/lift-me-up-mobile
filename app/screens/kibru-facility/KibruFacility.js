      ...
      <ScrollView>
        ...
        <View style={styles.main}>
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('OrderKibruUrine')}
          >
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('OrderKibrucbc')}
          >
            <View style={styles.hospital}>
              <View style={styles.hospitalname}>
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('OrderKibruSerumCreatine')}
          >
            <View style={styles.hospital}>
              <View style={styles.hospitalname}>
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('OrderKibruSerumPotassium')}
          >
            <View style={styles.hospital}>
              <View style={styles.hospitalname}>
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('OrderKibruSerumSodium')}
          >
            <View style={styles.hospital}>
              <View style={styles.hospitalname}>
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('OrderKibruLipase')}
          >
            <View style={styles.hospital}>
              <View style={styles.hospitalname}>
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('OrderKibruAmylase')}
          >
            <View style={styles.hospital}>
              <View style={styles.hospitalname}>
