...
const handleGoToNextScreenKibru = () => {
  setPopupVisible(false);
  navigation.navigate('OrderKibrucbc');
};

const handleGoToNextScreenNaol = () => {
  setPopupVisible(false);
  navigation.navigate('OrderNaolcbc');
};

const handleGoToNextScreenYanet = () => {
  setPopupVisible(false);
  navigation.navigate('OrderYanetcbc');
};
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <Text style={styles.test}>omplete Body Count (cbc)</Text>
