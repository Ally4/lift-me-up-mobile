...
export default function SerumCreatineTest() {
...
const handlePopupClose = () => {
  ...
  setTimeout(() => {
    navigation.navigate('SerumCreatineTest');
  }, 300);
};
...
const handleGoToNextScreenKibru = () => {
  setPopupVisible(false);
  navigation.navigate('OrderKibruSerumCreatine');
};

const handleGoToNextScreenNaol = () => {
  setPopupVisible(false);
  navigation.navigate('OrderNaolSerumCreatine');
};

const handleGoToNextScreenYanet = () => {
  setPopupVisible(false);
  navigation.navigate('OrderYanetSerumCreatine');
};
