...
export default function LipaseTest() {
...
const handlePopupClose = () => {
  ...
  setTimeout(() => {
    navigation.navigate('LipaseTest');
  }, 300);
};
...
const handleGoToNextScreenKibru = () => {
  setPopupVisible(false);
  navigation.navigate('OrderKibruLipase');
};

const handleGoToNextScreenNaol = () => {
  setPopupVisible(false);
  navigation.navigate('OrderNaolLipase');
};

const handleGoToNextScreenYanet = () => {
  setPopupVisible(false);
  navigation.navigate('OrderYanetLipase');
};
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <Text style={styles.test}>Lipase</Text>
