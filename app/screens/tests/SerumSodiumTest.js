...
export default function SerumSodiumTest() {
...
const handlePopupClose = () => {
  ...
  setTimeout(() => {
    navigation.navigate('SerumSodiumTest');
  }, 300);
};
...
const handleGoToNextScreenKibru = () => {
  setPopupVisible(false);
  navigation.navigate('OrderKibruSerumSodium');
};

const handleGoToNextScreenNaol = () => {
  setPopupVisible(false);
  navigation.navigate('OrderNaolSerumSodium');
};

const handleGoToNextScreenYanet = () => {
  setPopupVisible(false);
  navigation.navigate('OrderYanetSerumSodium');
};
