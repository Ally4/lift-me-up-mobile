...
export default function AlymaseTest() {
...
const handlePopupClose = () => {
  ...
  setTimeout(() => {
    navigation.navigate('AlymaseTest');
  }, 300);
};
...
const handleGoToNextScreenKibru = () => {
  setPopupVisible(false);
  navigation.navigate('OrderKibruAmylase');
};

const handleGoToNextScreenNaol = () => {
  setPopupVisible(false);
  navigation.navigate('OrderNaolAmylase');
};

const handleGoToNextScreenYanet = () => {
  setPopupVisible(false);
  navigation.navigate('OrderYanetAmylase');
};
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <Text style={styles.test}>Amylase</Text>
